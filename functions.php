 ...
 *
 * Note on Style Loading:
 * This child theme relies on the parent Aegis theme to automatically load the
 * child theme's stylesheet. Therefore, no explicit wp_enqueue_scripts function
 * is required in this file to load style.css.
 *
